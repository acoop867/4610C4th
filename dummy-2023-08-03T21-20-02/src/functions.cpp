...
// rightReading=(ticksToInches(r1.rotation(deg))+ticksToInches(r2.rotation(deg))+ticksToInches(r3.rotation(deg)))/3;

//   return rightReading; // negative because right encoder is backwards
// }

// double leftReading;

// double getLeftReading() {
//   leftReading=(ticksToInches(l1.rotation(deg))+ticksToInches(l2.rotation(deg))+ticksToInches(l3.rotation(deg)))/3;
...
// {
//   return Inertial4.rotation(deg); // Important that this is negative
...
// {
//   l1.spin(fwd, speed, pct);
//   l2.spin(fwd, speed, pct);
//   l3.spin(fwd, speed, pct);
// }

// void setRightBase(double speed)
// {
//   r1.spin(fwd, speed, pct);
//   r2.spin(fwd, speed, pct);
//   r3.spin(fwd, speed, pct);
// }
